...
const base = (p: P) => { const { size = 16, ...rest } = p; return { width: size, height: size, viewBox: '0 0 24 24', fill: 'none', stroke: 'currentColor', strokeWidth: 1.7, strokeLinecap: 'round' as const, strokeLinejoin: 'round' as const, ...rest }; };

export const LogoMark = ({ size = 22, ...rest }: P) => (<svg width={size} height={size} viewBox="0 0 24 24" fill="none" {...rest}><rect x="2.5" y="4" width="15" height="11" rx="2" stroke="#ff6b3d" strokeWidth="1.9" /><rect x="9" y="9" width="12.5" height="11" rx="2" fill="#101114" stroke="#45d6c8" strokeWidth="1.9" /><circle cx="18.5" cy="5" r="2" fill="#ffd166" /></svg>);
...
export const IcWand = (p: P) => <svg {...base(p)}><path d="m5 19 9.5-9.5m2-2L19 5" /><path d="M18.5 8.5 15.5 5.5 17 4l3 3Z" /></svg>;
export const IcDice = (p: P) => <svg {...base(p)}><rect x="4" y="4" width="16" height="16" rx="3.5" /><circle cx="9" cy="9" r="1" fill="currentColor" stroke="none" /><circle cx="15" cy="15" r="1" fill="currentColor" stroke="none" /></svg>;
...
export const IcEyeOff = (p: P) => <svg {...base(p)}><path d="M4 4l16 16" /><path d="M9.9 5.9A9.6 9.6 0 0 1 12 5.5c6 0 9.5 6.5 9.5 6.5a17.6 17.6 0 0 1-3 3.6" /></svg>;
...
export const IcDevice = (p: P) => <svg {...base(p)}><rect x="3" y="5" width="14" height="10" rx="1.6" /><path d="M17 9h2.5A1.5 1.5 0 0 1 21 10.5v6A1.5 1.5 0 0 1 19.5 18H10" /></svg>;
