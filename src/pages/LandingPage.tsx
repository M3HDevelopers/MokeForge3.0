    ...
    <div className="min-h-screen bg-ink">
      ...
      <section className="max-w-7xl mx-auto px-6 py-20">
        ...
        <div className="mt-16 anim-fade-up" style={{ animationDelay: '0.4s' }}>
          <div className="relative rounded-2xl border border-line overflow-hidden shadow-2xl">
            <div className="aspect-video bg-panel flex items-center justify-center">
              <div className="text-center">
                <LogoMark size={80} />
                <p className="text-2xl font-bold mt-4" style={{ fontFamily: 'var(--font-disp)' }}>
                  Professional Editor Preview
                </p>
                <p className="text-sm mt-2" style={{ color: 'var(--color-dim)' }}>
                  Sign up to access the full editor
                </p>
              </div>
            </div>
          </div>
